...
var (
	...
	cacheImUsercenterUserAuthIdPrefix              = "cache:imUsercenter:userAuth:id:"
	cacheImUsercenterUserAuthAuthTypeAuthKeyPrefix = "cache:imUsercenter:userAuth:authType:authKey:"
	cacheImUsercenterUserAuthUserIdAuthTypePrefix  = "cache:imUsercenter:userAuth:userId:authType:"
)
...
func (m *defaultUserAuthModel) Insert(ctx context.Context, session sqlx.Session, data *UserAuth) (sql.Result, error) {
	...
	imUsercenterUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheImUsercenterUserAuthAuthTypeAuthKeyPrefix, data.AuthType, data.AuthKey)
	imUsercenterUserAuthIdKey := fmt.Sprintf("%s%v", cacheImUsercenterUserAuthIdPrefix, data.Id)
	imUsercenterUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheImUsercenterUserAuthUserIdAuthTypePrefix, data.UserId, data.AuthType)
	...
	}, imUsercenterUserAuthAuthTypeAuthKeyKey, imUsercenterUserAuthIdKey, imUsercenterUserAuthUserIdAuthTypeKey)
}

func (m *defaultUserAuthModel) FindOne(ctx context.Context, id int64) (*UserAuth, error) {
	imUsercenterUserAuthIdKey := fmt.Sprintf("%s%v", cacheImUsercenterUserAuthIdPrefix, id)
	var resp UserAuth
	err := m.QueryRowCtx(ctx, &resp, imUsercenterUserAuthIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultUserAuthModel) FindOneByAuthTypeAuthKey(ctx context.Context, authType string, authKey string) (*UserAuth, error) {
	imUsercenterUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheImUsercenterUserAuthAuthTypeAuthKeyPrefix, authType, authKey)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, imUsercenterUserAuthAuthTypeAuthKeyKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserAuthModel) FindOneByUserIdAuthType(ctx context.Context, userId int64, authType string) (*UserAuth, error) {
	imUsercenterUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheImUsercenterUserAuthUserIdAuthTypePrefix, userId, authType)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, imUsercenterUserAuthUserIdAuthTypeKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserAuthModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheImUsercenterUserAuthIdPrefix, primary)
}
