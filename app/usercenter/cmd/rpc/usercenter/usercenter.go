...
type (
	...
	GetUserByMobileResp       = pb.GetUserByMobileResp
	...
	SearchUsersByNicknameReq  = pb.SearchUsersByNicknameReq
	SearchUsersByNicknameResp = pb.SearchUsersByNicknameResp
	User                      = pb.User
...
func (m *defaultUsercenter) SearchUsersByNickname(ctx context.Context, in *SearchUsersByNicknameReq, opts ...grpc.CallOption) (*SearchUsersByNicknameResp, error) {
	client := pb.NewUsercenterClient(m.cli.Conn())
	return client.SearchUsersByNickname(ctx, in, opts...)
}
